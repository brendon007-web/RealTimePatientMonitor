...
# Using the persistent disk location for Render deployment
...
# --- PAGE SERVING ROUTES ---
# This section handles serving all your HTML files from the 'static' folder.

@app.route('/')
def root():
    # This serves your main index.html file as the homepage.
    return app.send_static_file('index.html')

# *** THIS IS THE NEW CODE THAT FIXES THE NAVIGATION ***
@app.route('/<path:filename>')
def serve_static_files(filename):
    # This route will catch any request for a file that isn't an API endpoint
    # (e.g., /selection.html, /gcs.html) and serve it from the 'static' folder.
